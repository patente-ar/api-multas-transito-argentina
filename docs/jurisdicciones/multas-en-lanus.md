---
title: "API multas en Lanús por patente"
description: "Documentacion para integrar consulta de multas de transito en Lanús por patente con la API de patente.ar."
permalink: /jurisdicciones/multas-en-lanus/
---

# API multas en Lanús por patente

Consultá gratis multas e infracciones de tránsito en Lanús — Ingresá la patente y verificá actas pendientes al instante

Esta pagina forma parte del repo publico [api-multas-transito-argentina](https://github.com/patente-ar/api-multas-transito-argentina) y funciona como documentacion tecnica para la jurisdiccion `multas-en-lanus`. La API usa el endpoint unico `POST /v1/consultas`, API key del producto `infracciones`, idempotencia y webhook de resultado. Referencia interna de cobertura: `infracciones-lanus`.

## Resumen local

Consultá gratis multas e infracciones en Lanús por patente o dominio. Juzgado de Faltas Municipal, descargos, pago y SINAI.

| Dato | Valor |
| --- | --- |
| Jurisdiccion | Lanús |
| Pagina publica | [patente.ar/multas-en-lanus](https://patente.ar/multas-en-lanus) |
| Slug publico | multas-en-lanus |
| Referencia de integracion | infracciones-lanus |
| Ultima actualizacion | 2026-06-09 |
| Organismo o fuente | Juzgado de Faltas Municipal de Lanús |
| Host oficial | lanus.gob.ar |
...
Idempotency-Key: multas-en-lanus-demo-001
...
- Organismo o fuente informativa: Juzgado de Faltas Municipal de Lanús
- Direccion publicada: Av. Hipólito Yrigoyen 3863, Lanús
- Horario publicado: Lunes a viernes de 8:00 a 14:00 hs
- Telefono o canal publicado: (011) 4357-5300
- Sitio oficial: [lanus.gob.ar](https://www.lanus.gob.ar)


## Contexto del organismo

El Juzgado de Faltas Municipal de Lanús es el organismo encargado de gestionar las infracciones de tránsito cometidas dentro del partido. Allí se pueden realizar descargos, consultar el estado de actas y gestionar el pago de multas de forma presencial. Si preferís evitar la fila, consultá gratis tus multas en Lanús online desde Patente.ar antes de acercarte.


## Pago online

La existencia de pago online de multas en Lanús debe verificarse en el sitio oficial lanus.gob.ar. En muchos partidos bonaerenses el trámite se realiza de forma presencial en el Juzgado de Faltas o en el portal infraccionesba.gba.gob.ar.


## Pago presencial

Podés acercarte al Juzgado de Faltas Municipal de Lanús en el horario de atención. Se aceptan pagos en efectivo y con tarjeta según las modalidades habilitadas por la Tesorería Municipal.


## Pago voluntario o descuento

Las condiciones de pago voluntario y descuentos en Lanús deben verificarse directamente en el Juzgado de Faltas Municipal.


## Descargo

Si considerás que una multa fue mal labrada o tenés argumentos para impugnarla, podés presentar un descargo ante Juzgado de Faltas Municipal. Antes de ir, consultá gratis tus multas en Lanús desde Patente.ar para tener el detalle de cada acta. El procedimiento general es:
...
Las multas de tránsito en Lanús siguen los plazos establecidos por la normativa provincial (Ley 13.927 de la Provincia de Buenos Aires) y la ordenanza municipal vigente.
...
Para infracciones cometidas en rutas provinciales o nacionales que atraviesan el Partido de Lanús (como el Acceso Sudeste, la Av. Hipólito Yrigoyen o la Av. 25 de Mayo), las multas son competencia provincial y se gestionan a través del sistema SINAI (Sistema Nacional de Administración de Infracciones) de la Agencia Nacional de Seguridad Vial. Estas infracciones no aparecen en Juzgado de Faltas Municipal. Referencia nacional: [SINAI](https://consultainfracciones.seguridadvial.gob.ar).
...
Si estás por comprar o vender un vehículo en Lanús, es fundamental verificar que no tenga multas de tránsito pendientes. Las infracciones impagas pueden bloquear la transferencia del dominio y generar costos inesperados para el comprador.
...
- **Verificación automática:** Nuestro sistema consulta en tiempo real las infracciones registradas en Juzgado de Faltas Municipal de Lanús, Buenos Aires.
- **Revisá el resultado:** Vas a ver el detalle de cada acta o boleta: fecha, tipo de infracción, monto y estado de pago.
- **Descargá tu informe:** Podés descargar un informe completo con todas las multas del vehículo en Lanús y otros municipios.
...
### ¿Cómo consultar multas en Lanús por patente?

Podés consultar multas e infracciones en Lanús ingresando la patente en Patente.ar. Nuestro sistema verifica automáticamente las actas registradas en Juzgado de Faltas Municipal y te muestra el detalle de cada infracción pendiente.

### ¿Qué necesito para consultar multas en Lanús?
...
### ¿Cómo consultar multas en Lanús por DNI?

Actualmente, la consulta de multas en Lanús se realiza por dominio del vehículo (patente), no por DNI. Ingresá la patente en Patente.ar para verificar si tiene infracciones pendientes. Si necesitás consultar multas asociadas a tu persona, podés acercarte a Juzgado de Faltas Municipal con tu DNI.

## Probar Lanús en Playground

Para validar una consulta de multas en Lanús, crea una cuenta, pedi habilitar la API `infracciones` y abri el Playground con una patente de prueba o un caso propio de integracion.
...
- [Consulta web de multas en Lanús](https://patente.ar/multas-en-lanus)
