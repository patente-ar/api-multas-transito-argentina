---
title: "API multas en Ezeiza por patente"
description: "Documentacion para integrar consulta de multas de transito en Ezeiza por patente con la API de patente.ar."
permalink: /jurisdicciones/multas-en-ezeiza/
---

# API multas en Ezeiza por patente

Consultá gratis tus multas de tránsito en Ezeiza en segundos — Ingresá la patente y verificá infracciones pendientes al instante

Esta pagina forma parte del repo publico [api-multas-transito-argentina](https://github.com/patente-ar/api-multas-transito-argentina) y funciona como documentacion tecnica para la jurisdiccion `multas-en-ezeiza`. La API usa el endpoint unico `POST /v1/consultas`, API key del producto `infracciones`, idempotencia y webhook de resultado. Referencia interna de cobertura: `infracciones-ezeiza`.

## Resumen local

Consultá gratis multas, infracciones y fotomultas en Ezeiza por patente. Juzgado de Faltas, descargo, pago y SINAI.

| Dato | Valor |
| --- | --- |
| Jurisdiccion | Ezeiza |
| Pagina publica | [patente.ar/multas-en-ezeiza](https://patente.ar/multas-en-ezeiza) |
| Slug publico | multas-en-ezeiza |
| Referencia de integracion | infracciones-ezeiza |
| Ultima actualizacion | 2026-06-09 |
| Organismo o fuente | Juzgado de Faltas Municipal de Ezeiza |
| Host oficial | ezeiza.gob.ar |
...
Idempotency-Key: multas-en-ezeiza-demo-001
...
- Organismo o fuente informativa: Juzgado de Faltas Municipal de Ezeiza
- Direccion publicada: P. Grousac 220, piso 1, Ezeiza
- Horario publicado: Lunes a viernes de 8:00 a 14:00 hs
- Telefono o canal publicado: (011) 4480-0262
- Sitio oficial: [ezeiza.gob.ar](https://www.ezeiza.gob.ar)


## Contexto del organismo

El Juzgado de Faltas Municipal de Ezeiza es el organismo encargado de gestionar las infracciones de tránsito cometidas dentro del partido. Allí se pueden realizar descargos, consultar el estado de actas y gestionar el pago de multas de forma presencial. Si preferís evitar la fila, consultá gratis tus multas en Ezeiza online desde Patente.ar antes de acercarte.


## Pago online

La existencia de pago online de multas en Ezeiza debe verificarse en el sitio oficial ezeiza.gob.ar. En muchos partidos bonaerenses el trámite se realiza de forma presencial en el Juzgado de Faltas o en el portal infraccionesba.gba.gob.ar.


## Pago presencial

Podés acercarte al Juzgado de Faltas Municipal de Ezeiza en el horario de atención. Se aceptan pagos en efectivo y con tarjeta según las modalidades habilitadas por la Tesorería Municipal.


## Pago voluntario o descuento

Las condiciones de pago voluntario y descuentos en Ezeiza deben verificarse directamente en el Juzgado de Faltas Municipal.


## Descargo

Si considerás que una multa fue mal labrada o tenés argumentos para impugnarla, podés presentar un descargo ante Juzgado de Faltas Municipal. Antes de ir, consultá gratis tus multas en Ezeiza desde Patente.ar para tener el detalle de cada acta. El procedimiento general es:
...
Las multas de tránsito en Ezeiza siguen los plazos establecidos por la normativa provincial (Ley 13.927 de la Provincia de Buenos Aires) y la ordenanza municipal vigente.
...
Para infracciones cometidas en rutas provinciales o nacionales que atraviesan el Partido de Ezeiza (como la Autopista Ricchieri o la Ruta Provincial 205), las multas son competencia provincial y se gestionan a través del sistema SINAI (Sistema Nacional de Administración de Infracciones) de la Agencia Nacional de Seguridad Vial. Estas infracciones no aparecen en Juzgado de Faltas Municipal. Referencia nacional: [SINAI](https://consultainfracciones.seguridadvial.gob.ar).
...
Si estás por comprar o vender un vehículo en Ezeiza, es fundamental verificar que no tenga multas de tránsito pendientes. Las infracciones impagas pueden bloquear la transferencia del dominio y generar costos inesperados para el comprador.
...
- **Verificación automática:** Nuestro sistema consulta en tiempo real las infracciones registradas en Juzgado de Faltas Municipal de Ezeiza, Buenos Aires.
- **Revisá el resultado:** Vas a ver el detalle de cada acta o boleta: fecha, tipo de infracción, monto y estado de pago.
- **Descargá tu informe:** Podés descargar un informe completo con todas las multas del vehículo en Ezeiza y otros municipios.
...
### ¿Cómo puedo saber si tengo multas en Ezeiza?

Podés consultar si tu vehículo tiene multas de tránsito en Ezeiza ingresando la patente en Patente.ar. Nuestro sistema verifica automáticamente las infracciones registradas en Juzgado de Faltas Municipal y te muestra el detalle de cada acta pendiente.

### ¿Qué necesito para consultar multas en Ezeiza?
...
### ¿Cómo consultar multas en Ezeiza por DNI?

Actualmente, la consulta de multas en Ezeiza se realiza por dominio del vehículo (patente), no por DNI. Ingresá la patente en Patente.ar para verificar si tiene infracciones pendientes. Si necesitás consultar multas asociadas a tu persona, podés acercarte a Juzgado de Faltas Municipal con tu DNI.

## Probar Ezeiza en Playground

Para validar una consulta de multas en Ezeiza, crea una cuenta, pedi habilitar la API `infracciones` y abri el Playground con una patente de prueba o un caso propio de integracion.
...
- [Consulta web de multas en Ezeiza](https://patente.ar/multas-en-ezeiza)
