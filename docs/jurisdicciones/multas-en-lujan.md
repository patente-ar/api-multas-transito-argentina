---
title: "API multas en Luján por patente"
description: "Documentacion para integrar consulta de multas de transito en Luján por patente con la API de patente.ar."
permalink: /jurisdicciones/multas-en-lujan/
---
...
Idempotency-Key: multas-en-lujan-demo-001
...
Para validar una consulta de multas en Luján, crea una cuenta, pedi habilitar la API `infracciones` y abri el Playground con una patente de prueba o un caso propio de integracion.
...
- [Consulta web de multas en Luján](https://patente.ar/multas-en-lujan)
