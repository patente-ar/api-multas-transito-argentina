---
title: "API multas en Sáenz Peña por patente"
description: "Documentacion para integrar consulta de multas de transito en Sáenz Peña por patente con la API de patente.ar."
permalink: /jurisdicciones/multas-en-saenz-pena/
---

# API multas en Sáenz Peña por patente

Consultá gratis tus multas de tránsito en Sáenz Peña en segundos — Ingresá la patente y verificá infracciones pendientes al instante

Esta pagina forma parte del repo publico [api-multas-transito-argentina](https://github.com/patente-ar/api-multas-transito-argentina) y funciona como documentacion tecnica para la jurisdiccion `multas-en-saenz-pena`. La API usa el endpoint unico `POST /v1/consultas`, API key del producto `infracciones`, idempotencia y webhook de resultado. Referencia interna de cobertura: `infracciones-saenz-pena`.

## Resumen local

Consultá gratis multas de tránsito en Sáenz Peña por patente. Juzgado de Faltas Municipal, descargo según ordenanza, SINAI provincial.

| Dato | Valor |
| --- | --- |
| Jurisdiccion | Sáenz Peña |
| Pagina publica | [patente.ar/multas-en-saenz-pena](https://patente.ar/multas-en-saenz-pena) |
| Slug publico | multas-en-saenz-pena |
| Referencia de integracion | infracciones-saenz-pena |
| Ultima actualizacion | 2026-04-29 |
| Organismo o fuente | Juzgado de Faltas Municipal de Presidencia Roque Sáenz Peña |
| Host oficial | saenzpenia.gob.ar |
...
Idempotency-Key: multas-en-saenz-pena-demo-001
...
- Organismo o fuente informativa: Juzgado de Faltas Municipal de Presidencia Roque Sáenz Peña
- Direccion publicada: verificar
- Horario publicado: verificar
- Telefono o canal publicado: verificar
- Sitio oficial: [saenzpenia.gob.ar](https://www.saenzpenia.gob.ar)


## Contexto del organismo

El Juzgado de Faltas Municipal de Presidencia Roque Sáenz Peña gestiona las infracciones de tránsito en el ejido urbano de la ciudad. Las infracciones en rutas son competencia de la autoridad provincial. Si preferís evitar la fila, consultá gratis tus multas en Sáenz Peña online desde Patente.ar antes de acercarte.


## Pago online

La existencia de portal online de pago de multas en Sáenz Peña debe verificarse en saenzpenia.gob.ar.


## Pago presencial

El pago presencial se realiza en el Juzgado de Faltas Municipal en el horario de atención. Verificá las modalidades vigentes.


## Pago voluntario o descuento

Las condiciones de pago voluntario y descuento por pronto pago en Sáenz Peña deben verificarse directamente en el Juzgado de Faltas Municipal.


## Descargo

Si considerás que una multa fue mal labrada o tenés argumentos para impugnarla, podés presentar un descargo ante Juzgado de Faltas Municipal. Antes de ir, consultá gratis tus multas en Sáenz Peña desde Patente.ar para tener el detalle de cada acta. El procedimiento general es:
...
Las multas de tránsito en Presidencia Roque Sáenz Peña siguen los plazos establecidos por la normativa municipal vigente y la Ley Nacional 24.449.
...
Para infracciones cometidas en rutas provinciales o nacionales que atraviesan Presidencia Roque Sáenz Peña (como la Ruta Nacional 16 o la Ruta Provincial 13), las multas son competencia provincial y se gestionan a través del sistema SINAI (Sistema Nacional de Administración de Infracciones) de la Agencia Nacional de Seguridad Vial. Estas infracciones no aparecen en Juzgado de Faltas Municipal. Referencia nacional: [SINAI](https://consultainfracciones.seguridadvial.gob.ar).
...
Si estás por comprar o vender un vehículo en Sáenz Peña, es fundamental verificar que no tenga multas de tránsito pendientes. Las infracciones impagas pueden bloquear la transferencia del dominio y generar costos inesperados para el comprador.
...
- **Verificación automática:** Nuestro sistema consulta en tiempo real las infracciones registradas en Juzgado de Faltas Municipal de Presidencia Roque Sáenz Peña, Chaco.
- **Revisá el resultado:** Vas a ver el detalle de cada acta o boleta: fecha, tipo de infracción, monto y estado de pago.
- **Descargá tu informe:** Podés descargar un informe completo con todas las multas del vehículo en Sáenz Peña y otros municipios.
...
### ¿Cómo puedo saber si tengo multas en Sáenz Peña?

Podés consultar si tu vehículo tiene multas de tránsito en Sáenz Peña ingresando la patente en Patente.ar. Nuestro sistema verifica automáticamente las infracciones registradas en Juzgado de Faltas Municipal y te muestra el detalle de cada acta pendiente.

### ¿Qué necesito para consultar multas en Sáenz Peña?
...
### ¿Cómo consultar multas en Sáenz Peña por DNI?

Actualmente, la consulta de multas en Sáenz Peña se realiza por dominio del vehículo (patente), no por DNI. Ingresá la patente en Patente.ar para verificar si tiene infracciones pendientes. Si necesitás consultar multas asociadas a tu persona, podés acercarte a Juzgado de Faltas Municipal con tu DNI.

## Probar Sáenz Peña en Playground

Para validar una consulta de multas en Sáenz Peña, crea una cuenta, pedi habilitar la API `infracciones` y abri el Playground con una patente de prueba o un caso propio de integracion.
...
- [Consulta web de multas en Sáenz Peña](https://patente.ar/multas-en-saenz-pena)
