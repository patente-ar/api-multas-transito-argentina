---
title: "API multas en Bonpland por patente"
description: "Documentacion para integrar consulta de multas de transito en Bonpland por patente con la API de patente.ar."
permalink: /jurisdicciones/multas-en-bonpland/
---
...
Idempotency-Key: multas-en-bonpland-demo-001
...
Para validar una consulta de multas en Bonpland, crea una cuenta, pedi habilitar la API `infracciones` y abri el Playground con una patente de prueba o un caso propio de integracion.
...
- [Consulta web de multas en Bonpland](https://patente.ar/multas-en-bonpland)
