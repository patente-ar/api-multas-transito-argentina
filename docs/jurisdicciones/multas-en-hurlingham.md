---
title: "API multas en Hurlingham por patente"
description: "Documentacion para integrar consulta de multas de transito en Hurlingham por patente con la API de patente.ar."
permalink: /jurisdicciones/multas-en-hurlingham/
---

# API multas en Hurlingham por patente

Consultá gratis tus multas de tránsito en Hurlingham en segundos — Ingresá la patente y verificá infracciones pendientes al instante

Esta pagina forma parte del repo publico [api-multas-transito-argentina](https://github.com/patente-ar/api-multas-transito-argentina) y funciona como documentacion tecnica para la jurisdiccion `multas-en-hurlingham`. La API usa el endpoint unico `POST /v1/consultas`, API key del producto `infracciones`, idempotencia y webhook de resultado. Referencia interna de cobertura: `infracciones-hurlingham`.

## Resumen local

Consultá gratis multas de tránsito en Hurlingham por patente. Juzgado de Faltas Municipal, descargo en 5 días hábiles, SINAI.

| Dato | Valor |
| --- | --- |
| Jurisdiccion | Hurlingham |
| Pagina publica | [patente.ar/multas-en-hurlingham](https://patente.ar/multas-en-hurlingham) |
| Slug publico | multas-en-hurlingham |
| Referencia de integracion | infracciones-hurlingham |
| Ultima actualizacion | 2026-07-01 |
| Organismo o fuente | Juzgado de Faltas Municipal de Hurlingham |
| Host oficial | hurlingham.gob.ar |
...
Idempotency-Key: multas-en-hurlingham-demo-001
...
- Organismo o fuente informativa: Juzgado de Faltas Municipal de Hurlingham
- Direccion publicada: Avenida Vergara 3666
- Horario publicado: Lunes a viernes de 8:30 a 13:30 hs
- Telefono o canal publicado: verificar
- Sitio oficial: [hurlingham.gob.ar](https://www.hurlingham.gob.ar)


## Contexto del organismo

El Juzgado de Faltas Municipal de Hurlingham es el organismo encargado de gestionar las infracciones de tránsito cometidas dentro del partido. Allí se pueden realizar descargos, consultar el estado de actas y gestionar el pago de multas de forma presencial. Si preferís evitar la fila, consultá gratis tus multas en Hurlingham online desde Patente.ar antes de acercarte.


## Pago online

La existencia de pago online de multas en Hurlingham debe verificarse en el sitio oficial hurlingham.gob.ar. En muchos partidos bonaerenses el trámite se realiza de forma presencial en el Juzgado de Faltas o en el portal infraccionesba.gba.gob.ar.


## Pago presencial

InfraccionesBA publica atención municipal en Avenida Vergara 3666, de lunes a viernes de 8:30 a 13:30 hs. Confirmá el medio de pago y el juzgado que interviene en la notificación antes de concurrir.


## Pago voluntario o descuento

Las condiciones de pago voluntario y descuentos en Hurlingham deben verificarse directamente en el Juzgado de Faltas Municipal.


## Descargo

Si considerás que una multa fue mal labrada o tenés argumentos para impugnarla, podés presentar un descargo ante Juzgado de Faltas Municipal. Antes de ir, consultá gratis tus multas en Hurlingham desde Patente.ar para tener el detalle de cada acta. El procedimiento general es:
...
Las multas de tránsito en Hurlingham siguen los plazos establecidos por la normativa provincial (Ley 13.927 de la Provincia de Buenos Aires) y la ordenanza municipal vigente.
...
Si estás por comprar o vender un vehículo en Hurlingham, es fundamental verificar que no tenga multas de tránsito pendientes. Las infracciones impagas pueden bloquear la transferencia del dominio y generar costos inesperados para el comprador.
...
- **Verificación automática:** Nuestro sistema consulta en tiempo real las infracciones registradas en Juzgado de Faltas Municipal de Hurlingham, Buenos Aires.
- **Revisá el resultado:** Vas a ver el detalle de cada acta o boleta: fecha, tipo de infracción, monto y estado de pago.
- **Descargá tu informe:** Podés descargar un informe completo con todas las multas del vehículo en Hurlingham y otros municipios.
...
### ¿Cómo puedo saber si tengo multas en Hurlingham?

Podés consultar si tu vehículo tiene multas de tránsito en Hurlingham ingresando la patente en Patente.ar. Nuestro sistema verifica automáticamente las infracciones registradas en Juzgado de Faltas Municipal y te muestra el detalle de cada acta pendiente.

### ¿Qué necesito para consultar multas en Hurlingham?
...
### ¿Cómo consultar multas en Hurlingham por DNI?

Actualmente, la consulta de multas en Hurlingham se realiza por dominio del vehículo (patente), no por DNI. Ingresá la patente en Patente.ar para verificar si tiene infracciones pendientes. Si necesitás consultar multas asociadas a tu persona, podés acercarte a Juzgado de Faltas Municipal con tu DNI.

## Probar Hurlingham en Playground

Para validar una consulta de multas en Hurlingham, crea una cuenta, pedi habilitar la API `infracciones` y abri el Playground con una patente de prueba o un caso propio de integracion.
...
- [Consulta web de multas en Hurlingham](https://patente.ar/multas-en-hurlingham)
