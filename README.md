...
[![API examples](https://img.shields.io/badge/API-examples-blue)](https://patente.ar/api-multas)
[![OpenAPI](https://img.shields.io/badge/OpenAPI-3.1-green)](./openapi/openapi.yaml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](./LICENSE)

Ejemplos de integracion para api de multas de transito en argentina usando la API de [patente.ar](https://patente.ar).
...
El producto queda definido por la API key emitida para `infracciones`. Este repositorio contiene ejemplos, contrato OpenAPI, manejo de idempotencia y verificacion de webhooks para integrar API multas Argentina.
